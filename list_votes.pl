...
<a href="https://my.ergoport.dev/cgi-bin/ergo/list_votes.pl?a=$a">List Votes</a><br></p>
          ...
          <div class="row justify-content-center">
            <div class="col-md-12">
	      <a href="https://my.ergoport.dev/cgi-bin/ergo/archived_votes.pl?a=$a">--> Click here for Archived Votes</a>
              <p>Please click the link below a vote to open the full details and vote page.<br><br><br></p>
...
$sql = "select * from votedata where active_status='yes';";
